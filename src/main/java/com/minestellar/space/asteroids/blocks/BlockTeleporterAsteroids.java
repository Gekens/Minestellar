...
public class BlockTeleporterAsteroids extends BlockBreakable {
	...
	public BlockTeleporterAsteroids(String name) {
		super(MinestellarAsteroids.MODID + name, Material.portal, false);
	...
	public void onEntityCollidedWithBlock(World world, int x, int y, int z, Entity entity) {
		if ((entity.ridingEntity == null) && (entity.riddenByEntity == null) && ((entity instanceof EntityPlayerMP))) {
			...
			} else if (thePlayer.dimension != ConfigManagerAsteroids.idDimensionAsteroids) {
				thePlayer.timeUntilPortal = 10;
				thePlayer.mcServer.getConfigurationManager().transferPlayerToDimension(thePlayer, ConfigManagerAsteroids.idDimensionAsteroids, new TeleporterAsteroids(thePlayer.mcServer.worldServerForDimension(ConfigManagerAsteroids.idDimensionAsteroids)));
			} else {
				thePlayer.timeUntilPortal = 10;
				thePlayer.mcServer.getConfigurationManager().transferPlayerToDimension(thePlayer, 0, new TeleporterAsteroids(thePlayer.mcServer.worldServerForDimension(0)));
			}
		}
	}
	...
	public void registerBlockIcons(IIconRegister iconRegister) {
		this.blockIcon = iconRegister.registerIcon(MinestellarAsteroids.TEXTURE_PREFIX + "asteroids_portal");
	}
