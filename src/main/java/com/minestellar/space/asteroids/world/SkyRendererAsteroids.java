...
public class SkyRendererAsteroids extends IRenderHandler {
	...
	public void render(float partialTicks, WorldClient world, Minecraft mc) {
		WorldProviderAsteroids gcProvider = null;

		if (world.provider instanceof WorldProviderAsteroids) {
			gcProvider = (WorldProviderAsteroids) world.provider;
		}
		...
		var12 = 30.0F;
		FMLClientHandler.instance().getClient().renderEngine.bindTexture(SkyRendererAsteroids.sunTexture);
