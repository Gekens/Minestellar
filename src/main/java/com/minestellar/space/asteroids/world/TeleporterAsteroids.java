...
public class TeleporterAsteroids extends Teleporter {
	...
	public TeleporterAsteroids(WorldServer par1WorldServer) {
	...
	public boolean placeInExistingPortal(Entity par1Entity, double par2, double par4, double par6, float par8) {
			...
			for (l3 = l - short1; l3 <= l + short1; ++l3) {
				...
				for (int l1 = i1 - short1; l1 <= i1 + short1; ++l1) {
					...
					for (int i2 = this.worldServerInstance.getActualHeight() - 1; i2 >= 0; --i2) {
						if (this.worldServerInstance.getBlock(l3, i2, l1) == AsteroidsBlocks.asteroidsPortal) {
							while (this.worldServerInstance.getBlock(l3, i2 - 1, l1) == AsteroidsBlocks.asteroidsPortal) {
								--i2;
							}
		...
		if (d3 >= 0.0D) {
			...
			if (this.worldServerInstance.getBlock(i - 1, j, k) == AsteroidsBlocks.asteroidsPortal) {
				i4 = 2;
			}
			...
			if (this.worldServerInstance.getBlock(i, j, k - 1) == AsteroidsBlocks.asteroidsPortal) {
				i4 = 3;
			}
			...
			for (i3 = -1; i3 <= 1; ++i3) {
				for (j3 = 1; j3 < 3; ++j3) {
					for (k3 = -1; k3 < 3; ++k3) {
						...
						j4 = k2 + (j3 - 1) * l2 - i3 * l5;
						flag = k3 < 0;
						this.worldServerInstance.setBlock(l3, i4, j4, flag ? CoreBlocks.teleportBlock : Blocks.air);
					}
				}
			}
		}
		...
		for (i3 = 0; i3 < 4; ++i3) {
			for (j3 = 0; j3 < 4; ++j3) {
				for (k3 = -1; k3 < 4; ++k3) {
					...
					this.worldServerInstance.setBlock(l3, i4, j4, (Block) (flag ? CoreBlocks.teleportBlock : AsteroidsBlocks.asteroidsPortal), 0, 2);
				}
			}
