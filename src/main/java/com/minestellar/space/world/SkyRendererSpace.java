...
public class SkyRendererSpace extends IRenderHandler{
	...
	public void render(float partialTicks, WorldClient world, Minecraft mc) {
		WorldProviderSpace gcProvider = null;
		
		if(world.provider instanceof WorldProviderSpace){
			gcProvider = (WorldProviderSpace) world.provider;
		}
		...
		var12 = 30.0F;
		FMLClientHandler.instance().getClient().renderEngine.bindTexture(SkyRendererSpace.sunTexture);
