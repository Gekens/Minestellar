...
import com.minestellar.space.orbit.world.TeleporterOrbit;

import cpw.mods.fml.relauncher.Side;
import cpw.mods.fml.relauncher.SideOnly;

public class BlockTeleporterOrbit extends BlockBreakable {
	...
	public BlockTeleporterOrbit(String name) {
		super(MinestellarOrbit.MODID + name, Material.portal, false);
	...
	public void onEntityCollidedWithBlock(World world, int x, int y, int z, Entity entity) {
		if ((entity.ridingEntity == null) && (entity.riddenByEntity == null) && ((entity instanceof EntityPlayerMP))) {
			...
			} else if (thePlayer.dimension != ConfigManagerOrbit.idDimensionOrbit) {
				thePlayer.timeUntilPortal = 10;
				thePlayer.mcServer.getConfigurationManager().transferPlayerToDimension(thePlayer, ConfigManagerOrbit.idDimensionOrbit, new TeleporterOrbit(thePlayer.mcServer.worldServerForDimension(ConfigManagerOrbit.idDimensionOrbit)));
			} else {
				thePlayer.timeUntilPortal = 10;
				thePlayer.mcServer.getConfigurationManager().transferPlayerToDimension(thePlayer, 0, new TeleporterOrbit(thePlayer.mcServer.worldServerForDimension(0)));
			}
		}
	}
	...
	public void registerBlockIcons(IIconRegister iconRegister) {
		this.blockIcon = iconRegister.registerIcon(MinestellarOrbit.TEXTURE_PREFIX + "orbit_portal");
	}
