...
public class SkyRendererOrbit extends IRenderHandler {
	...
	public void render(float partialTicks, WorldClient world, Minecraft mc) {
		WorldProviderOrbit gcProvider = null;

		if (world.provider instanceof WorldProviderOrbit) {
			gcProvider = (WorldProviderOrbit) world.provider;
		}
		...
		var12 = 30.0F;
		FMLClientHandler.instance().getClient().renderEngine.bindTexture(SkyRendererOrbit.sunTexture);
