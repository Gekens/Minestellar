...
public class ChunkProviderOrbit extends ChunkProviderMinestellar {
	private final BiomeDecoratorOrbit spaceBiomeDecorator = new BiomeDecoratorOrbit();

	public ChunkProviderOrbit(World par1World, long seed, boolean mapFeaturesEnabled) {
	...
	protected BiomeGenBase[] getBiomesForGeneration() {
		return new BiomeGenBase[] {BiomeGenBaseOrbit.orbit};
	}
