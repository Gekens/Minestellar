...
public class Vector3 implements Cloneable {
	...
	/**
	 * Gets the delta look position based on the rotation yaw and pitch. Minecraft coordinates are messed up. Y and Z are flipped. Yaw is displaced by
	 * 90 degrees. Pitch is inversed.
	 *
	 * @param rotationYaw
	 * @param rotationPitch
	 */
	 ...
	 *            - The world object.
	 * @param target
	 *            - The rotation in terms of Vector3. Convert using getDeltaPositionFromRotation()
