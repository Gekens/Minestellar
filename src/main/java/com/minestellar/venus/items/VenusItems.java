...
public class VenusItems {
	...
	public static Item venusPortalTrigger;
	...
	private static void initItems() {
		...
		VenusItems.venusPortalTrigger = new ItemPortalTrigger("venus_trigger");
	...
	private static void registerItems() {
		MinestellarVenus.registerItem(venusBasicItem);

		MinestellarVenus.registerItem(sulfurPickaxe);
		MinestellarVenus.registerItem(sulfurAxe);
		MinestellarVenus.registerItem(sulfurHoe);
		MinestellarVenus.registerItem(sulfurSpade);
		MinestellarVenus.registerItem(sulfurSword);

		MinestellarVenus.registerItem(sulfurHelmet);
		MinestellarVenus.registerItem(sulfurChestplate);
		MinestellarVenus.registerItem(sulfurLeggings);
		MinestellarVenus.registerItem(sulfurBoots);

		MinestellarVenus.registerItem(gemPickaxe);
		MinestellarVenus.registerItem(gemAxe);
		MinestellarVenus.registerItem(gemHoe);
		MinestellarVenus.registerItem(gemSpade);
		MinestellarVenus.registerItem(gemSword);

		MinestellarVenus.registerItem(gemHelmet);
		MinestellarVenus.registerItem(gemChestplate);
		MinestellarVenus.registerItem(gemLeggings);
		MinestellarVenus.registerItem(gemBoots);

		MinestellarVenus.registerItem(jetpack);

		MinestellarVenus.registerItem(venusPortalTrigger);
