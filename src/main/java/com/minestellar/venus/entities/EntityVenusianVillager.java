package com.minestellar.venus.entities;
...
public class EntityVenusianVillager extends EntityAgeable {
	...
	public EntityVenusianVillager func_90012_b(EntityAgeable par1EntityAgeable) {
		final EntityVenusianVillager entityvillager = new EntityVenusianVillager(this.worldObj);
