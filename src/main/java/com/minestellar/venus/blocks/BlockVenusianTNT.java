...
public class BlockVenusianTNT extends Block {
	...
	public void registerBlockIcons(IIconRegister par1IconRegister) {
		this.TNTSide = par1IconRegister.registerIcon(MinestellarVenus.TEXTURE_PREFIX + "venusianTNTSide");
		this.TNTTop = par1IconRegister.registerIcon(MinestellarVenus.TEXTURE_PREFIX + "venusianTNTTop");
		this.TNTBottom = par1IconRegister.registerIcon(MinestellarVenus.TEXTURE_PREFIX + "venusianTNTBottom");
	}
}
