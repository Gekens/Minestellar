...
import com.minestellar.venus.world.TeleporterVenus;

import cpw.mods.fml.relauncher.Side;
import cpw.mods.fml.relauncher.SideOnly;

public class BlockTeleporterVenus extends BlockBreakable {
	public static final int[][] field_150001_a = new int[][] { new int[0], { 3, 1 }, { 2, 0 } };

	private static final String __OBFID = "CL_00000284";

	public BlockTeleporterVenus(String name) {
		super(MinestellarVenus.MODID + name, Material.portal, false);
	...
	public void onEntityCollidedWithBlock(World world, int x, int y, int z, Entity entity) {
		if ((entity.ridingEntity == null) && (entity.riddenByEntity == null) && ((entity instanceof EntityPlayerMP))) {
			...
			} else if (thePlayer.dimension != ConfigManagerVenus.idDimensionVenus) {
				thePlayer.timeUntilPortal = 10;
				thePlayer.mcServer.getConfigurationManager().transferPlayerToDimension(thePlayer, ConfigManagerVenus.idDimensionVenus, new TeleporterVenus(thePlayer.mcServer.worldServerForDimension(ConfigManagerVenus.idDimensionVenus)));
			} else {
				thePlayer.timeUntilPortal = 10;
				thePlayer.mcServer.getConfigurationManager().transferPlayerToDimension(thePlayer, 0, new TeleporterVenus(thePlayer.mcServer.worldServerForDimension(0)));
			}
		}
	}
	...
	public void registerBlockIcons(IIconRegister iconRegister) {
		this.blockIcon = iconRegister.registerIcon(MinestellarVenus.TEXTURE_PREFIX + "venus_portal");
	}
