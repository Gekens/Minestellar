...
public class SkyRendererVenus extends IRenderHandler {
	//private static final ResourceLocation overworldTexture = new ResourceLocation("Minestellarcore:textures/gui/celestialbodies/mercury.png");
	...
	public SkyRendererVenus(IMinestellarWorldProvider provider) {
	...
	public void render(float partialTicks, WorldClient world, Minecraft mc) {
		...
		// Render sun
		f10 = 19.0F;
		mc.renderEngine.bindTexture(SkyRendererVenus.sunTexture);
		...
		FMLClientHandler.instance().getClient().renderEngine.bindTexture(SkyRendererVenus.overworldTexture);
		tessellator1.startDrawingQuads();
	...
	private void renderStars() {
		...
		for (int starIndex = 0; starIndex < (3750 * ConfigManagerCore.idStarMultiplier); ++starIndex) {
