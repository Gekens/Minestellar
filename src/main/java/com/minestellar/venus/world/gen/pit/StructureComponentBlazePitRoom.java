package com.minestellar.venus.world.gen.pit;
...
import com.minestellar.core.world.gen.StructureComponentMinestellar;
import com.minestellar.venus.blocks.VenusBlocks;

public class StructureComponentBlazePitRoom extends StructureComponentMinestellar {
	...
	public StructureComponentBlazePitRoom(int type, World world, Random par2Random, int x, int y, int z, int height, int width, int cbm) {
		...
		this.height = height;
		this.width = width;
		this.boundingBox = StructureComponentMinestellar.getComponentToAddBoundingBox(x, 78 - this.height, z, 0, 0, 0, 7, this.height, 7, cbm);
	}
