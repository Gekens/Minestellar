...
public class TeleporterVenus extends Teleporter {
	...
	public TeleporterVenus(WorldServer par1WorldServer) {
		...
		for (i3 = 0; i3 < 4; ++i3) {
			for (j3 = 0; j3 < 4; ++j3) {
				for (k3 = -1; k3 < 4; ++k3) {
					...
					this.worldServerInstance.setBlock(l3, i4, j4, flag ? CoreBlocks.teleportBlock : VenusBlocks.venusPortal, 0, 2);
				}
			}
