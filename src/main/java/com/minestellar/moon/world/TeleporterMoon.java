...
public class TeleporterMoon extends Teleporter{
	...
	public TeleporterMoon(WorldServer p_i1963_1_)
	{
		super(p_i1963_1_);
	...
	public boolean placeInExistingPortal(Entity p_77184_1_, double p_77184_2_, double p_77184_4_, double p_77184_6_, float p_77184_8_)
	{
		...
		if (d3 >= 0.0D)
		{
			if (flag)
			{
				this.destinationCoordinateCache.add(j1, new TeleporterMoon.PortalPosition(i, j, k, this.worldServerInstance.getTotalWorldTime()));
