...
import com.minestellar.utils.MathHelper;
...
public class GuiDraw{
    ...
    public static void drawLine(int x1, int y1, int x2, int y2, float thickness, float red, float green, float blue, float alpha){
