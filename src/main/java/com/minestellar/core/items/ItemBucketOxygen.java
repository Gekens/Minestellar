...
public class ItemBucketOxygen extends ItemBucket {
	...
	public ItemBucketOxygen(String name) {
		super(CoreBlocks.oxygenFluidBlock);
		this.isFull = CoreBlocks.oxygenFluidBlock;
	...
	public void registerIcons(IIconRegister iconRegister) {
		this.itemIcon = iconRegister.registerIcon(MinestellarCore.TEXTURE_PREFIX + "oxygen_bucket");
	}
}
