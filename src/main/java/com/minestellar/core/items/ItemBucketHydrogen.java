...
public class ItemBucketHydrogen extends ItemBucket {
	private Block isFull;

	public ItemBucketHydrogen(String name) {
		super(CoreBlocks.hydrogenFluidBlock);
		this.isFull = CoreBlocks.hydrogenFluidBlock;
	...
	public void registerIcons(IIconRegister iconRegister) {
		this.itemIcon = iconRegister.registerIcon(MinestellarCore.TEXTURE_PREFIX + "hydrogen_bucket");
	}
}
