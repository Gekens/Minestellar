...
public class BlockFluidHydrogen extends BlockFluidClassic {
	...
	public static IIcon hydrogenFlowingIcon;

	public BlockFluidHydrogen(String name, Fluid fluid, Material par2Material) {
	...
	public IIcon getIcon(int par1, int par2) {
		return par1 != 0 && par1 != 1 ? BlockFluidHydrogen.hydrogenStillIcon : BlockFluidHydrogen.hydrogenFlowingIcon;
	}
	...
	public void registerBlockIcons(IIconRegister par1IconRegister) {
		BlockFluidHydrogen.hydrogenStillIcon = par1IconRegister.registerIcon(MinestellarCore.TEXTURE_PREFIX + "hydrogen_flowing");
		BlockFluidHydrogen.hydrogenFlowingIcon = par1IconRegister.registerIcon(MinestellarCore.TEXTURE_PREFIX + "hydrogen_still");
	}
	...
	public void randomDisplayTick(World world, int x, int y, int z, Random rand) {
		...
		if (rand.nextInt(10) == 0 && World.doesBlockHaveSolidTopSurface(world, x, y - 1, z) && !world.getBlock(x, y - 2, z).getMaterial().blocksMovement()) {
			...
			MinestellarCore.proxy.spawnParticle("hydrogenDrip", d5, d6, d7);
		}
	}
}
