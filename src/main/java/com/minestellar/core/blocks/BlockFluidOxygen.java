...
public class BlockFluidOxygen extends BlockFluidClassic {
	...
	public static IIcon oxygenFlowingIcon;

	public BlockFluidOxygen(String name, Fluid fluid, Material par2Material) {
	...
	public IIcon getIcon(int par1, int par2) {
		return par1 != 0 && par1 != 1 ? BlockFluidOxygen.oxygenStillIcon : BlockFluidOxygen.oxygenFlowingIcon;
	}
	...
	public void registerBlockIcons(IIconRegister par1IconRegister) {
		BlockFluidOxygen.oxygenStillIcon = par1IconRegister.registerIcon(MinestellarCore.TEXTURE_PREFIX + "oxygen_flowing");
		BlockFluidOxygen.oxygenFlowingIcon = par1IconRegister.registerIcon(MinestellarCore.TEXTURE_PREFIX + "oxygen_still");
	}
	...
	public void randomDisplayTick(World world, int x, int y, int z, Random rand) {
		...
		if (rand.nextInt(10) == 0 && World.doesBlockHaveSolidTopSurface(world, x, y - 1, z) && !world.getBlock(x, y - 2, z).getMaterial().blocksMovement()) {
			...
			MinestellarCore.proxy.spawnParticle("oxygenDrip", d5, d6, d7);
		}
	}
}
