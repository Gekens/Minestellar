/**
 * Copyright (c) 28/05/15 Davide Cossu & Matthew Albrecht.
 * <p/>
...
import com.minestellar.core.model.ModelAntenna;

public class TileEntityRenderAntenna extends TileEntitySpecialRenderer{

    public static ModelAntenna modelAntenna;

    public TileEntityRenderAntenna(){
        modelAntenna = new ModelAntenna();
    }
