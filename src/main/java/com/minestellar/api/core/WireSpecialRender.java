...
public class WireSpecialRender extends TileEntitySpecialRenderer{
	...
	private float texturePixelX, texturePixelY, location, blockDimension;
	...
	/**
	 * Draws the connector with other wires
	 */
	...
	private void drawConnector(ForgeDirection direction){
		...
		tessellator.startDrawingQuads();
		{
			...
			
			{
				...
				tessellator.addVertexWithUV(1 - location * pixel / 2, 1, 1 - location * pixel / 2, blockDimension * 2, blockDimension * texturePixelY);
				tessellator.addVertexWithUV(location * pixel / 2, 1, 1 - location * pixel / 2, blockDimension * 2, 0);
				...
				tessellator.addVertexWithUV(location * pixel / 2, 1, location * pixel / 2, blockDimension * 2, 5 * texturePixelY);
				tessellator.addVertexWithUV(1 - location * pixel / 2, 1, location * pixel / 2, blockDimension * 2, 0);
				...
				tessellator.addVertexWithUV(1 - location * pixel / 2, 1, location * pixel / 2, 10, blockDimension * texturePixelY);
				tessellator.addVertexWithUV(1 - location * pixel / 2, 1, 1 - location * pixel / 2, blockDimension * 2, 0);
				...
				tessellator.addVertexWithUV(location * pixel / 2, 1, 1 - location * pixel / 2, blockDimension * 2, 5 * texturePixelY);
				tessellator.addVertexWithUV(location * pixel / 2, 1, location * pixel / 2, blockDimension * 2, 0);
