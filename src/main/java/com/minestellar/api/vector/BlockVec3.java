...
public class BlockVec3 implements Cloneable {
	 ...
	 *
	 * @param world
	 * @return the block ID, or null if the y-coordinate is less than 0 or greater than 256 or the x or z is outside the Minecraft worldmap. Returns Blocks.bedrock if the coordinates being checked are in an unloaded chunk
	 */
	...
	/**
	 * Get block ID at the BlockVec3 coordinates without forcing a chunk load. Only call this 'safe' version if x and z coordinates are within the Minecraft world map (-30m to +30m)
	 *
	 * @param world
	 * @return the block ID, or null if the y-coordinate is less than 0 or greater than 256. Returns Blocks.bedrock if the coordinates being checked are in an unloaded chunk
	 */
