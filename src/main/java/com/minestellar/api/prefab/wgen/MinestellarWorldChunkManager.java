package com.minestellar.api.prefab.wgen;
...
public abstract class MinestellarWorldChunkManager extends WorldChunkManager
{
    private final BiomeCache biomeCache;
    private final List<BiomeGenBase> biomesToSpawnIn;

    public MinestellarWorldChunkManager()
    {
